(function () {
    angular.module("app.data")
        .factory("weatherSvc", function ($http, $q, weatherImgUrl, weatherSvcUrl, countryFlagImgUrl, APIKey) {
            ...
            function findByLocation(location) {
                var defer = $q.defer();
                var url = weatherSvcUrl + "find?q=" + location + "&" + "appid=" + APIKey;
            ...
            function getCurrentWeather(id) {
                var defer = $q.defer();
                var url = weatherSvcUrl + "weather?id=" + id + "&appid=" + APIKey;
            ...
            function getForecast(id) {
                var defer = $q.defer();
                var url = weatherSvcUrl + "forecast/daily?id=" + id + "&appid=" + APIKey;
